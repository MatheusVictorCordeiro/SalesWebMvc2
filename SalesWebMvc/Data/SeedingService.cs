...
namespace SalesWebMvc2.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            //verifica se o banco de dados ja foi populado.

            if (_context.Department.Any() ||
                _context.Seller.Any() ||
                _context.SalesRecord.Any())
            {
                return; //não faz nada , porque o banco de dados ja foi populado.
            }
            else
            {
                ...
                //adcionando ao banco de dados, o AddRange permite adcionar varios objetos de uma só vez.
                ...
                //chamamos essa função Seed, no Startup.cs
